...
const UpcomingEventsComponent = ({className, userProfile, accessToken, page}) => {
    ...
    return (
      <React.Fragment>
        ...
        <div className={className || wrapperClass}>
          <UpcomingEvents {...componentProps} {...this.props} />
        </div>
      </React.Fragment>
    )
};
...
export default connect(mapStateToProps, { addToSchedule, removeFromSchedule })(withAccessToken(UpcomingEventsComponent))
