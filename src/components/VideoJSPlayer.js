      ...
      this.player.on('error', () => {
        ...
        if (firstHalf !== null && videoError.code === 2 || videoError.code === 4) {
          if (reloadPlayer === null) {
            ...
            let message = firstHalf ? 'This video stream will begin momentarily. Please standby.' : 'This video will be available on-demand shortly.<br>Please check back here soon.';
